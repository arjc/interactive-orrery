...
const ControlPanel = ({ showOverlay, toggleOrbit, isOrbitVisible, toggleLabel, isLabelVisible, resetView }) => {
    ...
    return (
        <div className="text-white fixed w-screen md:h-screen md:w-auto bottom-0 md:top-0 left-0 flex flex-col gap-5 items-center bg-[#0005] border-t-2 md:border-r-2 md:border-t-0 p-10">
            ...
            <div className="flex md:flex-col flex-wrap items-center justify-center gap-5">
                ...
                <span className="button button-sm w-50" onClick={resetView}>(WIP)</span>
